...
# 'variables' a variable is a named piece of memory that stores data, for instance on the next line I will store an string (sequence of characters) into a variable
